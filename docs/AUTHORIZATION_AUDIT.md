...
| TEST-01 | Высокий | `dotnet test` молча пропускал проект без `IsTestProject` | Включён реальный test discovery; 26 тестов выполняются, включая негативные HTTP-сценарии |
