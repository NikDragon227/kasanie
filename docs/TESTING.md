...
- xUnit (26 тестов): normalizer в обоих направлениях, границы score, приоритет плана, отсутствие повтора, точная граница 14 лет, роли, admin policy, отсутствие PII properties, unit- и HTTP-проверки чужих player/session ID, региональная изоляция, privacy threshold, приглашение/установка пароля, ошибки парольной политики без ложного сообщения о ссылке, самостоятельная смена пароля, перевыпуск приглашения, административный сброс и блокировка без удаления;
