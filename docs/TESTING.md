...
- xUnit (22 теста): normalizer в обоих направлениях, границы score, приоритет плана, отсутствие повтора, точная граница 14 лет, роли, admin policy, отсутствие PII properties, unit- и HTTP-проверки чужих player/session ID, региональная изоляция, privacy threshold, приглашение/установка пароля и блокировка без удаления;
