...
- xUnit (19 тестов): normalizer в обоих направлениях, границы score, приоритет плана, отсутствие повтора, точная граница 14 лет, роли, admin policy, отсутствие PII properties, unit- и HTTP-проверки чужих player/session ID, региональная изоляция и privacy threshold;
