...
- xUnit (31 тест): normalizer в обоих направлениях, границы score, приоритет плана, возраст, роли, admin policy, отсутствие PII, ресурсные проверки, региональная изоляция, privacy threshold, приглашения и парольные сценарии, создание школы с владельцем, изоляция двух школ, полный цикл командного журнала и запрет тренеру создавать занятие чужой команды;
