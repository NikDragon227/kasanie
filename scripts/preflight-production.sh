...
for KEY in POSTGRES_PASSWORD APP_DOMAIN APP_BASE_URL SMTP_HOST SMTP_USERNAME SMTP_PASSWORD SMTP_FROM SMTP_SUPPORT_INBOX VITE_LEGAL_OPERATOR_NAME VITE_LEGAL_OPERATOR_ADDRESS VITE_LEGAL_OPERATOR_TAX_ID VITE_PRIVACY_CONTACT VITE_SUPPORT_EMAIL; do
  VALUE=$(value "$KEY")
