...
export function RegistrationChoicePage() {
  return <div className="join-page">
    <header className="entry-nav"><Link className="brand" to="/"><span className="brand-emblem brand-emblem-outlined"><img src="/brand/kasanie-logo-official.png" alt="" /></span><span><strong>КАСАНИЕ</strong><small>спортивная платформа</small></span></Link><Link className="button ghost" to="/login">Уже есть аккаунт</Link></header>
...
export function LandingPage() {
  ...
  return <div className="landing landing-v2">
    <header className="landing-nav landing-nav-v2">
      <Link className="brand" to="/"><span className="brand-emblem brand-emblem-outlined"><img src="/brand/kasanie-logo-official.png" alt="" /></span><span><strong>КАСАНИЕ</strong><small>спортивная платформа</small></span></Link>
    ...
    <footer className="landing-footer-v2"><Link className="brand" to="/"><span className="brand-emblem brand-emblem-outlined"><img src="/brand/kasanie-logo-official.png" alt="" /></span><span><strong>КАСАНИЕ</strong><small>спортивная платформа</small></span></Link><div><a href="#how">Как работает</a><a href="#roles">Для кого</a><Link to="/login">Войти</Link></div><span>© 2026 · DEMO-нормы не являются научно валидированными</span></footer>
  </div>
}
