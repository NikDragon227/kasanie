...
export function AppShell() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <NavLink className="brand" to={roleHome[role] ?? '/'}><span className="brand-emblem"><img src="/brand/kasanie-mark-light.svg" alt="" /></span><span><strong>КАСАНИЕ</strong><small>спортивная платформа</small></span></NavLink>
