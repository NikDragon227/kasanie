...
describe('critical workflows', () => {
  ...
  it('shows public nearby activities without authentication', async () => {
    ...
    expect(screen.getByRole('link', { name: 'Пользовательское соглашение' })).toHaveAttribute('href', '/documents/terms')
    expect(screen.getByRole('link', { name: 'Политика конфиденциальности' })).toHaveAttribute('href', '/documents/privacy')
